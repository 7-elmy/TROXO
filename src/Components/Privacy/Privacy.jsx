...
export default function Privacy() {
  ...
  const highlightContent = (text) => {
    ...
    const staticUrl = '<a href="https://gotroxo.com" target="_blank" rel="noopener noreferrer" class="text-[#FC746C] underline">https://gotroxo.com</a>';
    const staticDomain =  '<a href="https://gotroxo.com" target="_blank" rel="noopener noreferrer" class="text-[#FC746C] ">gotroxo.com</a>'
    // Replace patterns with colored spans or anchor tags
    return text
      .replace(emailRegex, '<span class="text-[#FC746C]">$1</span>')
