...
import smsa from "../../assets/partners/smsa.png.png";
    ...
    <section className={`overflow-hidden ${isArabic ? "rtl" : "ltr"} font-${isArabic ? "[Cairo]" : "[Poppins]"}`}>
      ...
      >
        ...
        <div className="col-span-12 md:col-span-6 md:pt-16 text-center">
          ...
          <div className="md:flex justify-between items-center gap-8 my-5 space-y-10 md:space-y-0">
            <img loading="lazy" className="mx-auto mt-8   md:m-0" src={smsa} alt="smsa" />
