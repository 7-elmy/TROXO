  ...
  return (
    <section >
      ...
      <div className="bg-white min-h-screen relative overflow-hidden">
                   <img className={`${isRTL ? "hidden":"absolute top-[130px] right-[-10%]"}`} loading='lazy' src={wave} alt="waves" />
        ...
        <div dir={isRTL ? "rtl" : "ltr"} className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-12 md:col-span-6 flex justify-center items-center z-10">
            <div className={`flex flex-col justify-center bg-white p-8 rounded-md items-${!isRTL? "center":"center md:end "} space-y-8`}>
