...
//           <p className="text-[24px]  font-[Poppins] font-[700] text-[#FC746C] ">Our Services</p>
...
//             <li>
//               <a className="text-[#461A2D] font-[Poppins] transition hover:text-[#461A2D] text-[16px]" href="#"> Blogs </a>
//             </li>
//           </ul>
//         </div>
...
//         <div className="text-center sm:text-left">
//           <p className="text-[24px]  font-[Poppins] font-[700] text-[#FC746C] ">Explore More</p>

//           <ul className="mt-8 space-y-4 text-sm">
//           <li>
//               <a className="text-[#461A2D] font-[Poppins] transition hover:text-[#461A2D] text-[16px]" href="#"> Terms and Conditions</a>
//             </li>
//             <li>
//               <a className="text-[#461A2D] font-[Poppins] transition hover:text-[#461A2D] text-[16px]" href="#"> Privacy Policy </a>
//             </li>

//             <li>
//               <a className="text-[#461A2D] font-[Poppins] transition hover:text-[#461A2D] text-[16px]" href="#"> FAQs </a>
//             </li>
...
//         <div className="text-center sm:text-left">
//           <p className="text-[24px]  font-[Poppins] font-[700] text-[#FC746C] ">Contact Us</p>
...
//                 href="#"
//               >
//                <SlPhone className='text-lg text-[#4D1A2D]'/>
...
//                   className="size-5 shrink-0 text-[#4D1A2D]"
//                   fill="none"
//                   viewBox="0 0 24 24"
//                   stroke="currentColor"
//                   strokeWidth="2"
...
//                 <span className="md:flex-1 text-[#461A2D] font-[Poppins]">john@doe.com</span>
//               </a>
//             </li>
//           </ul>
//         </div>
...
//         <p className="text-[10px] text-[#461A2D]">
//         © 2023 POSTGAIT Inc.

//         </p>

//         <p className="mt-4 text-[10px] text-[#461A2D] sm:order-first sm:mt-0">© 2023 POSTGAIT.com, subsidiary of Iktsar Elzaman. All rights reserved.</p>
//       </div>
//     </div>
//   </div>
// </footer>
        ...
        <div className={`grid grid-cols-1 gap-8 lg:grid-cols-3 ${isArabic ? "text-right" : "text-left"}`}>
          ...
          <div className={`grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2 ${isArabic ? "text-right" : "text-left"}`}>
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li className={`flex items-start ${isArabic ? "justify-end" : "justify-start"} gap-1.5`}>
                  <CiLocationOn className="text-lg text-[#4D1A2D]" />
                ...
                <li>
                  <a className={`flex items-center ${isArabic ? "justify-end" : "justify-start"} gap-1.5`} href="#">
                    <SlPhone className="text-lg text-[#4D1A2D]" />
                    <span className="text-[#461A2D] font-[Poppins]">+966 055 021 0280</span>
                  </a>
                </li>
                <li>
                  <a className={`flex items-center ${isArabic ? "justify-end" : "justify-start"} gap-1.5`} href="#">
                    ...
                    <span className="text-[#461A2D] font-[Poppins]">john@doe.com</span>
                  </a>
                </li>
              </ul>
            </div>
